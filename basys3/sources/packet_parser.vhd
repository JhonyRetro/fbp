...
entity packet_parser is
    port (
        ...
        delay_out    : out std_logic_vector(15 downto 0) := (others => '0');
...
architecture rtl of packet_parser is
    ...
    type state_type is (WAIT_SYNC, READ_CTRL, READ_X_H, READ_X_L, READ_Y_H, READ_Y_L, READ_DELAY_H, READ_DELAY_L);
    ...
    signal y_l_reg  : std_logic_vector(7 downto 0) := (others => '0');
    signal delay_h_reg  : std_logic_vector(7 downto 0) := (others => '0');
            ...
            if rx_done_tick = '1' then
                ...
                case state is
                    ...
                    when READ_DELAY_L =>
                        ...
                        dy_steps <= y_h_reg & y_l_reg;

                        delay_out <= delay_h_reg & rx_data;
